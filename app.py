...
trestbps = st.sidebar.number_input("Presión Arterial en Reposo (mmHg)", min_value=0, max_value=200, value=120)
chol = st.sidebar.number_input("Colesterol (mg/dl)", min_value=0, max_value=600, value=200)
...
thalach = st.sidebar.number_input("Frecuencia Cardíaca Máxima", min_value=0, max_value=220, value=150)
